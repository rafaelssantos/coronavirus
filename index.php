...
<body>
	...
	<div class='content'>
		<div class='update-panel-container'>
			<span>Última atualização em 05 de maio de 2020 às 16:57.</span>
		</div>
		...
		<div class='cases-panel-container'>
			...
			<div class='cases-label-container' id='label-curados'>
				<span class='cases-label'>Curados</span><span class='cases-counter'>006</span>
			</div>
			...
			<div class='cases-label-container' id='label-aguardando-resultados'>
				<span class='cases-label'>Aguardando resultados</span><span class='cases-counter'>010</span>
			</div>
...
<script>
		...
		type: 'line',
		data: {
			labels: ['21/03', '22/03', '23/03', '24/03', '25/03', '26/03', '27/03', '28/03', '29/03', '30/03', '31/03', '01/04', '02/04', '03/04', '04/04', '05/04', '06/04', '07/04', '08/04', '09/04', '10/04', '11/04', '12/04', '13/04', '14/04', '15/04', '16/04', '17/04', '18/04', '19/04', '20/04', '21/04', '22/04', '23/04', '24/04', '25/04', '26/04', '27/04', '28/04', '29/04', '30/04', '01/05', '02/05', '03/05', '04/05', '05/05'],
			datasets: [
			{
				data: [04, 04, 06, 06, 12, 12, 15, 15, 15, 14, 17, 14, 15, 14, 14, 10, 10, 12, 13, 14, 12, 11, 12, 10, 09, 09, 07, 09, 08, 07, 06, 07, 07, 07, 08, 08, 08, 07, 08, 08, 09, 09, 06, 06, 04, 10],
				label: "Suspeitos",
				borderColor: "#FFFF00",
				fill: false
			},
			{
				data: [00, 01, 04, 04, 04, 04, 04, 04, 04, 05, 05, 05, 06, 06, 06, 06, 06, 06, 06, 07, 07, 07, 07, 08, 09, 09, 07, 04, 04, 04, 02, 03, 01, 01, 01, 01, 01, 01, 01, 01, 01, 00, 06, 06, 06, 10],
				label: "Exames aguardando resultado",
				borderColor: "#FFA500",
				fill: false
			},
			{
				data: [00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 02, 02, 02, 03, 03, 03, 03, 03, 06],
				label: "Curados",
				borderColor: "#0000FF",
				fill: false
			}, 
			{
				data: [00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 02, 02, 02, 02, 04, 04, 04, 04, 04, 05, 05, 06, 06, 06, 06, 09],
				label: "Confirmados",
				borderColor: "#FF0000",
				fill: false
			},
			{
				data: [00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 01, 01, 02, 02, 02, 02],
				label: "Óbitos",
				borderColor: "#000000",
				fill: false
			}]

...
<body>
	...
	<div class='content'>
		<div class='update-panel-container'>
			<span>Última atualização em 21 de abril de 2020 às 16:30.</span>
		</div>
		...
		<div class='cases-panel-container'>
			...
			<div class='cases-label-container' id='label-suspeitos-em-investigacao'>
				<span class='cases-label'>**Suspeitos em investigação</span><span class='cases-counter'>003</span>
			</div>
			<div class='cases-label-container' id='label-recuperados'>
				<span class='cases-label'>***Recuperados</span><span class='cases-counter'>032</span>
			</div>
			<div class='cases-label-container' id='label-descartados-por-exame'>
				<span class='cases-label'>Descartados por exame</span><span class='cases-counter'>005</span>
			</div>
			<div class='cases-label-container' id='label-suspeitos-em-internacao-hospitalar'>
				<span class='cases-label'>Internação Hospitalar</span><span class='cases-counter'>003</span>
			</div>
			<div class='cases-label-container' id='label-confirmados-por-exame'>
				<span class='cases-label'>Confirmados por exame</span><span class='cases-counter'>002</span>
			</div>
...
<script>
	new Chart(document.getElementById("cases-chart"), {
		type: 'line',
		data: {
			labels: ['21/03', '22/03', '23/03', '24/03', '25/03', '26/03', '27/03', '28/03', '29/03', '30/03', '31/03', '01/04', '02/04', '03/04', '04/04', '05/04', '06/04', '07/04', '08/04', '09/04', '10/04', '11/04', '12/04', '13/04', '14/04', '15/04', '16/04', '17/04', '18/04', '19/04', '20/04', '21/04'],
			datasets: [{
				data: [04, 04, 06, 06, 12, 12, 15, 15, 15, 14, 17, 14, 15, 14, 14, 10, 10, 12, 13, 14, 12, 11, 12, 10, 09, 08, 07, 09, 08, 07, 06, 07],
				label: "Suspeitos em monitoramento",
				borderColor: "#FFFF00",
				fill: false
			},
			{
				data: [00, 01, 04, 04, 04, 04, 04, 04, 04, 05, 05, 05, 06, 06, 06, 06, 06, 06, 06, 07, 07, 07, 07, 08, 09, 09, 09, 04, 04, 04, 02, 03],
				label: "Suspeitos em investigação",
				borderColor: "#FFC800",
				fill: false
			},
			{
				data: [00, 00, 00, 00, 00, 00, 00, 00, 01, 01, 03, 03, 04, 05, 06, 16, 16, 17, 18, 18, 20, 20, 20, 23, 26, 28, 29, 29, 30, 31, 32, 32],
				label: "Recuperados",
				borderColor: "#0000FF",
				fill: false
			}, {
				data: [00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 05, 05, 05, 05, 05],
				label: "Descartados por exame",
				borderColor: "#008000",
				fill: false
			}, {
				data: [00, 00, 00, 00, 00, 00, 00, 00, 00, 01, 01, 01, 01, 01, 01, 01, 01, 01, 01, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 03],
				label: "Internação Hospitalar",
				borderColor: "#8B0000",
				fill: false
			}, {
				data: [00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 02, 02],

...
<body>
	...
	<div class='content'>
		<div class="container-fluid">
			<p class='font-italic text-right'>Última atualização em 19 de junho de 2020 às 07:40.</p>
		</div>
...
<script>
	new Chart(document.getElementById("cases-chart-1"), {
		...
		data: {
			...
			datasets: [{
					data: [04, 04, 06, 06, 12, 12, 15, 15, 15, 14, 17, 14, 15, 14, 14, 10, 10, 12, 13, 14, 12, 11, 12, 10, 09, 09, 07, 09, 08, 07, 06, 07, 07, 07, 08, 08, 08, 07, 08, 08, 09, 09, 06, 06, 04, 10, 11, 12, 14, 15, 15, 16, 13, 13, 13, 13, 13, 13, 14, 18, 16, 11, 12, 14, 14, 14, 14, 09, 08, 08, 07, 11, 09, 12, 12, 14, 15, 16, 11, 10, 10, 11, 11, 11, 07, 06, 06, 10],
					label: "Suspeitos",
					borderColor: "#FFFF00",
					fill: false
				},
				{
					data: [00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 02, 02, 02, 02, 04, 04, 04, 04, 04, 05, 05, 06, 06, 06, 06, 09, 09, 10, 10, 10, 10, 10, 10, 10, 13, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20, 20, 20, 20, 21, 21, 21, 21, 21, 21, 22, 22, 22, 22],
					label: "Confirmados",
					borderColor: "#FF0000",
					fill: false
				},
				{
					data: [00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 01, 01, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02],
					label: "Óbitos",
					borderColor: "#000000",
					fill: false
				},
				{
					data: [00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 02, 02, 02, 03, 03, 03, 03, 03, 06, 07, 08, 08, 08, 08, 08, 08, 08, 11, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 17, 18, 18, 18, 18, 18, 18, 20, 20, 20, 20],
					label: "Curados",
					borderColor: "#0000FF",
					fill: false
				},
				{
					data: [00, 00, 00, 00, 00, 00, 00, 00, 00, 01, 01, 01, 01, 01, 01, 01, 01, 01, 01, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 02, 03, 03, 03, 02, 02, 02, 02, 02, 02, 02, 02, 01, 01, 01, 01, 01, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 01, 01, 01, 02, 02, 02, 03, 03, 01, 00, 00, 00, 00, 03, 03, 03, 03, 03, 03, 03, 03, 02, 02, 02, 02, 02, 02, 00, 00, 00, 00],
